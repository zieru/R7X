            ...
            <template v-slot:header="{props:{headers}}">
                ...
                <tr>
                    <th v-for="header in headers">
                        ...
                        <div v-else-if="header.value=='username'" :class="`text-${header.align}`"><v-icon>mdi-person</v-icon> {{header.text}}</div>
            ...
            <template v-slot:body="{items}">
                <tbody>
                    <tr v-for="item in items" :key="item.id">
                                ...
                                <v-list>
                                    ...
                                    >
                                        <v-list-item-title>
                                            ...
                                            Edit
                                        <v-btn @click="$router.push({name:'users.edit',params:{id: item.id}})" outlined icon color="info">
                                            <v-icon small>mdi-pencil</v-icon> Edit
                                        </v-btn>
                                        </v-list-item-title>
                                        <v-list-item-title>
                                            <v-icon small>mdi-delete</v-icon> Delete
                                        <v-btn @click="trash(item)" outlined icon color="red">
                        ...
                        <td>{{ item.email }}</td>
                        <td>
                            <v-btn small @click="showDialog('user_permissions',item.permissions)" outlined rounded color="primary" dark>Show</v-btn>
                        </td>
                        <td>
                            <v-chip v-for="group in item.groups" :key="group.id" color="primary" outlined small>
                                <v-icon>mdi-account-circle</v-icon>
                                {{group.name}}
                            </v-chip>
                        </td>
